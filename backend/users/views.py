...
from .serializers import UserRegisterSerializer, LoginSerializer, ResetPasswordSerializer, SetNewPasswordSerializer, \
    LogoutSerializer, UserSerializer, ProfileUpdateSerializer  # type:ignore
...
class ConfirmPassword(GenericAPIView):
    def get(self, request, uidb64, token):
        try:
            ...
            return Response({"Success": True, "message": "Cardenaltis is valid", "uidb64": uidb64, "token": token},
                            status=status.HTTP_200_OK)
