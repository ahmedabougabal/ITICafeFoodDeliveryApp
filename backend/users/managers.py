...
class UserManager(BaseUserManager):
    ...
    def create_user(self, email,first_name,last_name,branch,phone_number, password=None, **extra_fields):
        if email:
        ...
        user=self.model(email=email,first_name=first_name,last_name=last_name,branch=branch,phone_number=phone_number,**extra_fields)
